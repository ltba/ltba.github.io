...
本代码为奇趣保罗原创，并遵守 GPL 2.0 开源协议。由聆听·彼岸个性二次魔改.
    ...
    var action = {
        ...
        welcome: function () {
            if(document.referrer !== "" && document.referrer.indexOf(current.root) === -1){
                ...
                switch(referrer.hostname){
                    case "www.baidu.com":
                        modules.render("欢迎来自 百度搜索 的朋友！");
                    break;
                    case "www.so.com":
                        modules.render("欢迎来自 360搜索 的朋友！");
                    break;
        ...
        touch: function () {
            current.canvas.onclick = function () {
                modules.render(prop.content.touch || ["你在干什么？", "再摸我就报警了！","笨蛋，你个变态！", "HENTAI!", "不可以这样欺负我啦！"]);
            };
        },
        // 右侧按钮
        buttons: function () {
            ...
            elements.firework.onclick = function () {
                if(this.fk){this.fk._close();this.fk=false}else{
              this.fk=$('.firework').fireworks({ 
                  sound: true, // 声音效果
                  opacity: 1,
                  width: '100%', 
                  height: '100%'
                });
            };/*$.getScript("https://www.yyhy.me/q.js");*/};
            elements.firework.onmouseover = function () {
                modules.render("你想看烟花吗？");
                //modules.render("烟花看久了也不免有点腻，不如下点钱吧?");
            };
            current.menu.appendChild(elements.firework);
...
if (window.console && window.console.log) {
    console.log("Pio https://paugram.com ");
}